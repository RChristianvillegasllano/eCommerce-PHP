      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paypal">Payment Center/ E-Wallet</option>
            </select>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>ZIP CODE :</span>
            <input type="number" min="0" name="pin_code" placeholder="" min="0" max="999999" onkeypress="if(this.value.length == 4) return false;" class="box" required>
         </div>
      </div>
